  ...
  <nav class="navbar navbar-expand-lg py-3 sticky-top" style="background-color: var(--ColorPrincipal);">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#" style="color: var(--TextoClaro);">
          ...
          {{-- Botón de SALIR (Solo si el usuario está autenticado) --}}
          @auth
          ...
          @else
          {{-- O un botón de Iniciar Sesión si no está autenticado --}}
          <li class="nav-item ms-lg-3">
